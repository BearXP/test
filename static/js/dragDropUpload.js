...
function showFile(){
  ...
  // alert("File Extension: " + fileExtension)
  let validExtensions = ["xls", "xlsx"]; //adding some valid image extensions in array
  if(validExtensions.includes(fileExtension)){ //if user selected file is an image file
    // alert("Valid Filetype")
